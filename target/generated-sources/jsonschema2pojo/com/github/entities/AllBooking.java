...
public class AllBooking {
    ...
    public String toString() {
        ...
        sb.append(AllBooking.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("bookingid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AllBooking) == false) {
            return false;
        }
        AllBooking rhs = ((AllBooking) other);
